...
import co.com.sofkau.horseraces.usecases.game.commands.DoRematchUseCase;
...
class DoRematchUseCaseTest {
    @Mock
    private DomainEventRepository repository;

    @Test
    @DisplayName("Test rematch with valid arguments")
    void validArguments_doRematch() {
        //arrange
        var command = new DoRematch(
                new GameId("Game001"));
        ...
        var events = UseCaseHandler.getInstance()
                ...
                .orElseThrow()
                .getDomainEvents();
        var event = (RematchDone) events.get(0);
